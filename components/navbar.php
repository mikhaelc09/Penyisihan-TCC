<nav class="h-10 w-full pr-10 py-8 text-gray-100 flex justify-end items-center text-xl font-medium">
    <ul class="flex flex-row gap-5 items-center">
        <li class="transition-all hover:scale-110"><a href="index.php">Home</a></li>
        <li class="transition-all hover:scale-110"><a href="">Announcement</a></li>
        <li class="transition-all hover:scale-110"><a href="">Login</a></li>
        <li class="transition-all hover:scale-110"><a href="">Register</a></li>
    </ul>
</nav>