...
<script>
    ...
    // $("#createNav").click(()=>{
    //     if(!$("#createNav").hasClass("bg-tcc-darkEmerald")){
    //         $("#createNav").addClass("bg-tcc-darkEmerald")
    //         //Ajax Fetch Quiz Builder
    //     }
    // })

    // $("#listNav").click(()=>{
    //     if(!$("#listNav").hasClass("bg-tcc-darkEmerald")){
    //         $("#listNav").addClass("bg-tcc-darkEmerald")
    //         //Ajax Fetch Quiz List
    //     }
    // })
</script>