...
<body>
    <div class="w-full h-screen bg-tcc-darkBlue">
        ...
        <main class="w-full flex flex-col items-center py-10 gap-4">
            <section class="w-1/3 h-48 rounded-lg shadow-md bg-tcc-darkGray cursor-pointer flex items-center justify-center hover:bg-tcc-lightGray hover:underline underline-offset-4">
